...
public class UserPaidActivity extends AppCompatActivity {
    ...
    private void initView(){
        Toolbar toolbar = findViewById(R.id.user_bill_paid_toolbar);
        mRecycler = findViewById(R.id.user_bill_paid_recyclerView);
    ...
    private  void getPaid(){
        ...
        RequestQueue queue = VolleyModel.getInstance(this.getApplicationContext()).
                getRequestQueue();
        //请求地址以及json格式的请求内容
        String url = Host.DOMAIN +"/get_paid";
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.POST, url, jsonObject, new Response.Listener<JSONObject>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getApplication(),"无法获取历史账单",Toast.LENGTH_LONG).show();
